...
std::vector<std::string> Client::getTopics() {
    std::vector<std::string> test_topics = {"physics", "math", "computers"};
    return test_topics;
}
...
bool Client::putLikes(Author author, std::vector<std::string> topics) { return true; }
...
bool Client::putArticles(std::vector<std::string> articles) { return true; }

std::string Client::getTitle(Paper paper) { return "Title test"; }
